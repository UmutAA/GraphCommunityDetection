...
## Important
If you are using an OS other than Windows, time mesuring feature may not work on your device, given that the function was implemented for Windows OS. In order to run the program, you need to remove 'mesureElapsedTime' function's decleration and usages from source code.
